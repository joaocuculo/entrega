    ...
    <div id="container">
        <div class="box-login">
            ...
            <form action="autenticacao.php" method="post" class="box">
                ...
                <?php } ?>
                <input type="text" class="form-control input-field" name="nome" id="nome" placeholder="Nome" required>
                <input type="password" class="form-control input-field" name="senha" id="senha" placeholder="Senha" required>
